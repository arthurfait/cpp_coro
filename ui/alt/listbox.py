...
scroll = ttk.Scrollbar(c, orient=VERTICAL, command=lbox.yview)
...
scroll.grid(column=1, row=0, rowspan=6, sticky=(N,S))
...
for i in range(0,len(countrynames),2):
    lbox.itemconfigure(i, background='#ac50af')

for i in range(1,len(countrynames),2):
    lbox.itemconfigure(i, background='#7c104f')
